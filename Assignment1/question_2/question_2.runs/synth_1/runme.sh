...
HD_PWD='C:/Users/sfaul/Desktop/FPGA/question_2/question_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_2_bin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_2_bin.tcl
