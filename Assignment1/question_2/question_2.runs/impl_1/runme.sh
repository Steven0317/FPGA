...
HD_PWD='C:/Users/sfaul/Desktop/FPGA/question_2/question_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_2_bin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_2_bin.tcl -notrace
